...
private val forageableDao: ForageableDao
    ...
    // property to set to a list of all forageables from the DAO
    val forageable : LiveData<List<Forageable>> = forageableDao.getForageables().asLiveData()

    // method that takes id: Long as a parameter and retrieve a Forageable from the
    //  database by id via the DAO.
    fun getForageable(id: Long): LiveData<Forageable> = forageableDao.getForageables(id).asLiveData()
